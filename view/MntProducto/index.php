...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/cs-skin-elastic.css">
    <link rel="stylesheet" href="../../public/css/lib/datatable/dataTables.bootstrap.min.css">
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="../MntProducto/">Productos</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <script src="../../public/js/lib/data-table/buttons.bootstrap.min.js"></script>
    <script src="../../public/js/lib/data-table/jszip.min.js"></script>
    <script src="../../public/js/lib/data-table/vfs_fonts.js"></script>
    <script src="../../public/js/lib/data-table/buttons.html5.min.js"></script>
    <script src="../../public/js/lib/data-table/buttons.print.min.js"></script>
    <script src="../../public/js/lib/data-table/buttons.colVis.min.js"></script>
    <script src="../../public/js/init/datatables-init.js"></script>
